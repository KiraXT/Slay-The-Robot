...
- **User Communication**: 优先使用中文回复用户，除非用户明确要求使用其他语言。
- **Superpower Skill Docs**: When using superpower skills to write project development documents such as specs, plans, and implementation notes, default to Chinese unless the user explicitly requests another language.
