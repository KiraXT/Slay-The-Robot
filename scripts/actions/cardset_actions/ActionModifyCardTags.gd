...
func perform_action() -> void:
	var tags_to_add: Array[String] = _coerce_string_array(
		get_action_value("add_tags", get_action_value("card_tags_to_add", get_action_value("card_tags", []))),
		"add_tags"
	)
	var tags_to_remove: Array[String] = _coerce_string_array(
		get_action_value("remove_tags", get_action_value("card_tags_to_remove", [])),
		"remove_tags"
	)
...
func _to_string() -> String:
	return "Modify Card Tags Action"
